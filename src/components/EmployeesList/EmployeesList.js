...
const EmployeesList = (props) => {
    ...
    return (
        <>
            ...
            <br/>
            <label htmlFor="search">Search by First or Last Name: </label>
            <input id="search" ref={ inputRef } type="search" placeholder="Enter" onChange={ searchBarChangeHandler }></input>
            <br/>
            <br/>
            <i>Filters</i>
            <br/>
